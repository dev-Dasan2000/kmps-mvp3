...
router.get('/:lab_id/:security_question_id', async (req, res) => {
  try {
...
router.put('/:lab_id/:security_question_id', async (req, res) => {
  try {
    const { lab_id, security_question_id } = req.params;
...
router.delete('/:lab_id/:security_question_id', async (req, res) => {
  try {
    const { lab_id, security_question_id } = req.params;
