...
router.get('/:radiologist_id/:security_question_id',   async (req, res) => {
  try {
...
router.put('/:radiologist_id/:security_question_id',   async (req, res) => {
  try {
    const { radiologist_id, security_question_id } = req.params;
...
router.delete('/:radiologist_id/:security_question_id',   async (req, res) => {
  try {
    const { radiologist_id, security_question_id } = req.params;
