...
import { Search, Calendar, DollarSign, User, Clock, X, IndianRupee } from 'lucide-react';
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <CardTitle className="text-lg truncate">
                      {payment.patient?.name || "deleted patient"}
                    </CardTitle>
                    ...
                    <div className="flex items-center mt-1.5 text-emerald-600">
                      LKR
                      <span className="font-bold text-lg">{payment.appointment?.fee}</span>
                    </div>
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="font-medium text-gray-900 truncate">
                      {payment.dentist?.name || "deleted dentist"}
                    </div>
                    <div className="text-sm text-gray-500 truncate">
                      {payment.dentist?.email || "N/A"}
                    </div>
                  </div>
                </div>
